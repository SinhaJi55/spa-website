...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* BACKGROUND IMAGE */}
      <div
        className="absolute inset-0 bg-cover bg-center animate-[slowZoom_18s_linear_infinite]"
        style={{
      ...
      <motion.div
        ...
        className="absolute top-[-180px] left-[-150px] w-[350px] md:w-[550px] h-[350px] md:h-[550px] bg-white/10 blur-[120px] rounded-full"
      ></motion.div>
      ...
      <motion.div
        ...
        className="absolute bottom-[-200px] right-[-120px] w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-white/10 blur-[120px] rounded-full"
      ></motion.div>
      ...
      <div className="relative z-10 w-full max-w-7xl px-5 sm:px-8 lg:px-12 text-center">
        ...
        >
          ...
          <p className="uppercase tracking-[4px] md:tracking-[8px] text-white text-[11px] sm:text-xs md:text-sm">
        ...
        >
          <span className="block text-4xl sm:text-5xl md:text-7xl lg:text-[110px] drop-shadow-[0_0_20px_rgba(0,0,0,0.5)]">
            Unique B2B Spa
          </span>
          ...
          <motion.span
            ...
            className="block text-white/90 font-light mt-4 text-xl sm:text-2xl md:text-4xl lg:text-5xl"
          >
            Paharganj, New Delhi
          </motion.span>
        </motion.h1>
        ...
        <motion.p
          ...
          animate={{ opacity: 1 }}
          transition={{ delay: 1 }}
          className="text-white/90 mt-6 md:mt-8 max-w-3xl mx-auto text-sm sm:text-base md:text-lg lg:text-xl leading-7 md:leading-9 px-2"
        >
        ...
        >
          ...
          <button
            ...
            className="border border-white/60 hover:bg-white hover:text-black transition-all duration-500 hover:scale-105 px-8 md:px-10 py-3.5 md:py-4 rounded-full text-white font-semibold uppercase tracking-[2px] text-xs md:text-sm backdrop-blur-sm"
          >
            Explore Services
          </button>
